...
int main() {
  ...
  exibirLog(f);
  if(inserirElemento(f, 10, 10)) printf("ok\n");
  else printf("nok (5) esperado pq 10 é maior que max \n");
  exibirLog(f);
  if(inserirElemento(f, 4, 4)) printf("ok\n");
  else printf("nok (5)\n");
  exibirLog(f);
  ...
  exibirLog(f);
    if(inserirElemento(f, 9, 9)) printf("ok\n");
  else printf("nok (5)\n");
  exibirLog(f);
  ...
  if(reduzirPrioridade(f, 9, 0)) printf("ok\n");
  else printf("nok (15)\n");
  exibirLog(f);
  ...
  exibirLog(f);
  if(reduzirPrioridade(f, 7, 1.5)) printf("ok\n");
